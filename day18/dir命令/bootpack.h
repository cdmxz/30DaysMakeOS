...
#define COL8_BLACK 0       // ºÚÉ«
#define COL8_RED 1         // ´¿ºì
#define COL8_LIGHTGREEN 2  // ÁÁÂÌLime
#define COL8_YELLOW 3      // ´¿»Æ
#define COL8_BLUE 4        // ´¿À¶
#define COL8_LIGHTPURPLE 5 // ÑóºìÉ«
#define COL8_CYAN 6        // Ç³ÁÁÀ¶cyan
#define COL8_WHITE 7       // °×É«
#define COL8_LIGHTGREY 8   // ÁÁ»Ò DarkGray
#define COL8_DARKRED 9     // °µºì
#define COL8_DARKGREEN 10  // °µÂÌ
#define COL8_DARKYELLOW 11 // °µ»Æ
#define COL8_DARKBLUE 12   // °µÀ¶
#define COL8_DARKPURPLE 13 // °µ×Ï
#define COL8_DARKCYAN 14   // Ç³°µÀ¶
#define COL8_DARKGREY 15   // °µ»Ò
