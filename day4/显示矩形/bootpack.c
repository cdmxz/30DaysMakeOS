...
void boxfill8(unsigned char *vram, int xsize, unsigned char col8, int x0, int y0, int x1, int y1);
...
void HariMain(void)
{
    ...
    boxfill8(p, 320, COL8_LIGHTGREEN, 70, 50, 170, 150);
    boxfill8(p, 320, COL8_BLUE, 120, 80, 220, 180);
    while (1)
    {
        io_hlt();
    }
