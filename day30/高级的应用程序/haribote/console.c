...
void cmd_help(struct CONSOLE* cons, int* fat)
{
	cons_putstr_newline(cons, "支持的命令：");
	cons_putstr_newline(cons, "mem 内存");
	cons_putstr_newline(cons, "cls 清屏");
	cons_putstr_newline(cons, "dir 列出文件");
	cons_putstr_newline(cons, "exit");
	cons_putstr_newline(cons, "help");
	cons_putstr_newline(cons, "start");
	cons_putstr_newline(cons, "ncst 启动程序");
	cons_putstr_newline(cons, "langmode 语言模式");
}
